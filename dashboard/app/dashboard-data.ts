...
export const snapshot = {
  ...
  "generatedAt": "2026-08-14T06:59:57+08:00",
  "asOf": "2026/8/14 06:15 HKT",
  "marketGate": "风险偏高",
  "dataHealth": "绿灯",
  "coverage": 96,
  "riskScore": 71,
  ...
  "daily": {
    ...
    "signal": "黄灯",
    "action": "等待",
    "marketJudgement": "今天结论：黄灯偏防守，10/12只基金走弱，不是普通震荡；先控回撤，暂停加仓。",
    "positionAdvice": "仓位建议：高波动仓位先降速，AI/半导体、PCB、有色等只等放量修复，不补跌。",
    "needAction": "今日动作：1）停止追高和补跌；2）盯AI芯片/半导体、存储/HBM、历史新高能否放量收复；3）核对强弱分化：强项100055(全球科技互联网)日涨1.57%，弱项004432(有色金属)日跌3.58%。",
    "actionReason": "不操作原因：基金端普跌，估值分位、北向资金（月度）仍偏敏感，主线需成交和订单重新确认。",
    "riskPoint": "主要风险：科技链和高波动资产同步补跌；若成交不足，光模块/CPO、低空经济/军工可能继续拖累组合。",
    "nextReview": "下次复盘：看AI芯片/半导体、存储/HBM、历史新高是否放量止跌，光模块/CPO、低空经济/军工是否继续转弱。"
  },
  "freshness": [
    {
      "name": "风控",
...
export const risks = [
  [
    "10年期美债收益率",
    "4.68%（FRED，2026-08-12）",
    "green",
    "4.3% ~ 4.7%",
    "指标日期 2026-08-12，沿用最近可得数据（滞后2天）",
    "2026-08-12"
  ],
  [
    "北向资金（月度）",
  ...
  [
    ...
    "green",
    "DXY < 103",
    "指标日期 2026-08-13，沿用最近可得数据（滞后1天）",
    "2026-08-13"
  ],
  [
    "实际利率",
    "10年期TIPS实际利率2.42%（FRED，2026-08-12）",
    "yellow",
    "10Y TIPS < 2.2%",
    "指标日期 2026-08-12，沿用最近可得数据（滞后2天）",
    "2026-08-12"
  ...
  [
    "信用利差",
    "美国高收益债OAS 2.71%（FRED，2026-08-12）",
    "green",
    "高收益OAS < 3.5%",
    "指标日期 2026-08-12，沿用最近可得数据（滞后2天）",
    "2026-08-12"
  ...
  "details": [
    {
      ...
      "detail": "复核至2026/8/14：未发现巴菲特发布改变框架的新公开观点；继续把高现金、少数确定性资产和安全边际作为估值纪律校验，不把它当作短线交易信号。",
    ...
    },
    {
      ...
      "detail": "复核至2026/8/14：未发现张磊或高瓴新增可验证公开框架；继续作为中国成长价值和产业研究坐标，重点看创新药、先进制造和互联网平台盈利兑现。",
      "sourceStatus": "公开资料复核；若无新公开信/访谈/13F，则不强行编写新观点"
    },
    {
      ...
      "detail": "复核至2026/8/14：Oaktree官网近期有内容更新迹象，但未确认出现改变投资框架的新Marks观点；继续用风险补偿、信用周期和过热资产纪律校验AI与成长交易。",
      "sourceStatus": "公开资料复核；若无新公开信/访谈/13F，则不强行编写新观点"
    },
    {
      ...
      "detail": "复核至2026/8/14：未发现Dalio新增高可信公开观点改变配置框架；继续用债务周期、黄金、非美元资产和分散化原则校验宏观风险。",
      "sourceStatus": "公开资料复核；若无新公开信/访谈/13F，则不强行编写新观点"
    },
    {
      ...
      "detail": "复核至2026/8/14：未确认Ackman新增改变框架的公开观点；继续偏向少数高质量现金流龙头和可解释的资本配置，回避无法由现金流支撑的高估资产。",
      "sourceStatus": "公开资料复核；若无新公开信/访谈/13F，则不强行编写新观点"
    },
    {
      ...
      "detail": "复核至2026/8/14：未发现Tepper新增可靠公开观点；继续把他作为高弹性风险资产节奏参考，重点看AI硬件、平台消费和宏观风险偏好。",
      "sourceStatus": "公开资料复核；若无新公开信/访谈/13F，则不强行编写新观点"
    },
    {
      "name": "肯·格里芬 / Citadel",
      ...
      "detail": "复核至2026/8/14：未发现Griffin新增高确信公开观点改变框架；继续把Citadel作为流动性、波动率和市场结构观察样本。",
      "sourceStatus": "公开资料复核；若无新公开信/访谈/13F，则不强行编写新观点"
    },
    {
      "name": "克里斯·霍恩 / TCI",
      ...
      "detail": "复核至2026/8/14：未发现Hohn新增公开框架变化；继续沿用高壁垒平台、支付网络、评级和航空航天资产也必须服从估值纪律的结论。",
      "sourceStatus": "公开资料复核；若无新公开信/访谈/13F，则不强行编写新观点"
    },
    {
      "name": "凯瑟琳·伍德 / ARK",
      ...
      "detail": "复核至2026/8/14：ARK属于高频交易动作源，6/16之后仍需持续跟踪其每日交易披露；当前不能写成“无更新”，应把ARK作为高波动成长和创新资产情绪指标，而不是组合模板。",
      "sourceStatus": "公开资料复核；若无新公开信/访谈/13F，则不强行编写新观点"
    },
    {
      ...
      "detail": "复核至2026/8/14：未发现Druckenmiller新增高可信公开观点；继续沿用承认AI长期逻辑但不在短线拥挤时硬追、重视非共识机会和风险控制的框架。",
      "sourceStatus": "公开资料复核；若无新公开信/访谈/13F，则不强行编写新观点"
    }
  ],
  "strongDetails": [
...
export const funds = [
  {
    ...
    "risk": "高",
    "decision": "观察等待",
    "direction": "AI/半导体信号不够强，维持观察。 净值日期 2026-08-13，沿用最近可得数据（滞后1天）；数据源：东方财富基金历史净值API。",
    "date": "2026-08-13"
  },
  {
    "code": "100055",
    ...
    "risk": "中高",
    "decision": "观察等待",
    "direction": "全球科技互联网信号不够强，维持观察。 净值日期 2026-08-12，沿用最近可得数据（滞后2天）；数据源：东方财富基金历史净值API。",
    "date": "2026-08-12"
  },
  {
    "code": "006751",
    ...
    "risk": "中高",
    "decision": "观察等待",
    "direction": "AI/互联网信号不够强，维持观察。 净值日期 2026-08-13，沿用最近可得数据（滞后1天）；数据源：东方财富基金历史净值API。",
    "date": "2026-08-13"
  },
  {
    "code": "014344",
    ...
    "risk": "中",
    "decision": "观察等待",
    "direction": "A股宽基信号不够强，维持观察。 净值日期 2026-08-13，沿用最近可得数据（滞后1天）；数据源：东方财富基金历史净值API。",
    "date": "2026-08-13"
  },
  {
    "code": "007818",
    ...
    "risk": "高",
    "decision": "继续观察",
    "direction": "通信/设备短线修复，但仍需要验证趋势延续。 净值日期 2026-08-13，沿用最近可得数据（滞后1天）；数据源：东方财富基金历史净值API。",
    "date": "2026-08-13"
  },
  {
    "code": "013180",
    ...
    "risk": "中",
    "decision": "观察等待",
    "direction": "新能源车/电池信号不够强，维持观察。 净值日期 2026-08-13，沿用最近可得数据（滞后1天）；数据源：东方财富基金历史净值API。",
    "date": "2026-08-13"
  },
  {
    "code": "004432",
    ...
    "risk": "中高",
    "decision": "暂不加仓",
    "direction": "有色金属短线承压明显，等待企稳和成交确认。 净值日期 2026-08-13，沿用最近可得数据（滞后1天）；数据源：东方财富基金历史净值API。",
    "date": "2026-08-13"
  },
  {
    "code": "519704",
    ...
    "risk": "中",
    "decision": "观察等待",
    "direction": "先进制造信号不够强，维持观察。 净值日期 2026-08-13，沿用最近可得数据（滞后1天）；数据源：东方财富基金历史净值API。",
    "date": "2026-08-13"
  },
  {
    "code": "018125",
  ...
  },
  {
    ...
    "risk": "高",
    "decision": "观察等待",
    "direction": "光伏产业信号不够强，维持观察。 净值日期 2026-08-13，沿用最近可得数据（滞后1天）；数据源：东方财富基金历史净值API。",
    "date": "2026-08-13"
  },
  {
    "code": "025856",
    ...
    "risk": "中高",
    "decision": "观察等待",
    "direction": "电网设备信号不够强，维持观察。 净值日期 2026-08-13，沿用最近可得数据（滞后1天）；数据源：东方财富基金历史净值API。",
    "date": "2026-08-13"
  },
  {
    "code": "018896",
    ...
    "risk": "中高",
    "decision": "观察等待",
    "direction": "消费电子信号不够强，维持观察。 净值日期 2026-08-13，沿用最近可得数据（滞后1天）；数据源：东方财富基金历史净值API。",
    "date": "2026-08-13"
  }
] as const;
