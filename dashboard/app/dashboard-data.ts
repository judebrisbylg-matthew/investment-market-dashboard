...
export const snapshot = {
  ...
  "generatedAt": "2026-08-05T07:18:02+08:00",
  "asOf": "2026/8/5 06:15 HKT",
  "marketGate": "风险偏高",
  "dataHealth": "绿灯",
  "coverage": 96,
  "riskScore": 71,
  ...
  "daily": {
    ...
    "signal": "黄灯",
    "action": "等待",
    "marketJudgement": "今天结论：黄灯等待，科技看中东局势待确认，先看先进封装、苹果概念能否放量。",
    "positionAdvice": "仓位建议：维持中性偏谨慎，不追高，等主线确认。",
    "needAction": "今日动作：盯先进封装、苹果概念成交/订单；基金看强项006751(AI/互联网)日涨8.97%，弱项100055(全球科技互联网)日跌0.39%。",
    "actionReason": "不操作原因：估值分位、北向资金（月度）未转绿，科技看中东局势仍待确认。",
...
export const risks = [
  [
    "10年期美债收益率",
    "4.70%（FRED，2026-08-03）",
    "green",
    "4.3% ~ 4.7%",
    "指标日期 2026-08-03，沿用最近可得数据（滞后2天）",
    "2026-08-03"
  ],
  [
    "北向资金（月度）",
  ...
  [
    "美元指数",
    "DXY约99.88（东方财富美元指数口径，2026年8月4日）",
    "green",
    "DXY < 103",
    "指标日期 2026-08-04，沿用最近可得数据（滞后1天）",
    "2026-08-04"
  ],
  [
    "实际利率",
    "10年期TIPS实际利率2.43%（FRED，2026-08-03）",
    "yellow",
    "10Y TIPS < 2.2%",
    "指标日期 2026-08-03，沿用最近可得数据（滞后2天）",
    "2026-08-03"
  ...
  [
    "信用利差",
    "美国高收益债OAS 2.78%（FRED，2026-08-03）",
    "green",
    "高收益OAS < 3.5%",
    "指标日期 2026-08-03，沿用最近可得数据（滞后2天）",
    "2026-08-03"
  ...
  [
    ...
    "yellow",
    "主要央行流动性企稳/扩张",
    "指标日期 2026-07-29，沿用最近可得数据（滞后7天）",
    "2026-07-29"
  ],
  [
    "A股成交额",
    "沪深两市成交约2.21万亿元（东方财富指数口径，2026年8月4日）",
    "green",
    ">1.0万亿",
    "指标日期 2026-08-04，沿用最近可得数据（滞后1天）",
    "2026-08-04"
  ...
  [
    "港股成交额",
    "恒生指数成分成交约2578亿港元（非港股全市场口径，2026年8月4日）",
    "yellow",
    ">1500亿港元",
    "指标日期 2026-08-04，沿用最近可得数据（滞后1天）",
    "2026-08-04"
...
export const funds = [
  {
    ...
    "risk": "高",
    "decision": "观察等待",
    "direction": "AI/半导体短线涨幅较快，先看持续性和回撤，不追高。 净值日期 2026-08-04，沿用最近可得数据（滞后1天）；数据源：东方财富基金历史净值API。",
    "date": "2026-08-04"
  },
  {
    "code": "100055",
    ...
    "risk": "中高",
    "decision": "观察等待",
    "direction": "全球科技互联网信号不够强，维持观察。 净值日期 2026-08-03，沿用最近可得数据（滞后2天）；数据源：东方财富基金历史净值API。",
    "date": "2026-08-03"
  },
  {
    "code": "006751",
    ...
    "risk": "中高",
    "decision": "观察等待",
    "direction": "AI/互联网短线涨幅较快，先看持续性和回撤，不追高。 净值日期 2026-08-04，沿用最近可得数据（滞后1天）；数据源：东方财富基金历史净值API。",
    "date": "2026-08-04"
  },
  {
    "code": "014344",
    ...
    "risk": "中",
    "decision": "继续观察",
    "direction": "A股宽基短线修复，但仍需要验证趋势延续。 净值日期 2026-08-04，沿用最近可得数据（滞后1天）；数据源：东方财富基金历史净值API。",
    "date": "2026-08-04"
  },
  {
    "code": "007818",
    ...
    "risk": "高",
    "decision": "观察等待",
    "direction": "通信/设备短线涨幅较快，先看持续性和回撤，不追高。 净值日期 2026-08-04，沿用最近可得数据（滞后1天）；数据源：东方财富基金历史净值API。",
    "date": "2026-08-04"
  },
  {
    "code": "013180",
    ...
    "risk": "中",
    "decision": "继续观察",
    "direction": "新能源车/电池短线修复，但仍需要验证趋势延续。 净值日期 2026-08-04，沿用最近可得数据（滞后1天）；数据源：东方财富基金历史净值API。",
    "date": "2026-08-04"
  },
  {
    "code": "004432",
    ...
    "risk": "中高",
    "decision": "继续观察",
    "direction": "有色金属短线修复，但仍需要验证趋势延续。 净值日期 2026-08-04，沿用最近可得数据（滞后1天）；数据源：东方财富基金历史净值API。",
    "date": "2026-08-04"
  },
  {
    "code": "519704",
    ...
    "risk": "中",
    "decision": "继续观察",
    "direction": "先进制造短线修复，但仍需要验证趋势延续。 净值日期 2026-08-04，沿用最近可得数据（滞后1天）；数据源：东方财富基金历史净值API。",
    "date": "2026-08-04"
  },
  {
    "code": "018125",
  ...
  },
  {
    ...
    "risk": "高",
    "decision": "继续观察",
    "direction": "光伏产业短线修复，但仍需要验证趋势延续。 净值日期 2026-08-04，沿用最近可得数据（滞后1天）；数据源：东方财富基金历史净值API。",
    "date": "2026-08-04"
  },
  {
    "code": "025856",
    ...
    "risk": "中高",
    "decision": "继续观察",
    "direction": "电网设备短线修复，但仍需要验证趋势延续。 净值日期 2026-08-04，沿用最近可得数据（滞后1天）；数据源：东方财富基金历史净值API。",
    "date": "2026-08-04"
  },
  {
    "code": "018896",
    ...
    "risk": "中高",
    "decision": "观察等待",
    "direction": "消费电子短线涨幅较快，先看持续性和回撤，不追高。 净值日期 2026-08-04，沿用最近可得数据（滞后1天）；数据源：东方财富基金历史净值API。",
    "date": "2026-08-04"
  }
] as const;
